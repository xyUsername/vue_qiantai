<template>
    <div class="login">
        <section>
            <img src="../../../assets/logo.jpg" alt="logo"  class="login">
            <!-- 表单内容 -->
            ...
            <el-form :model="ruleForm2" :rules="rules2" status-icon show-message ref="abc" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item>
                    <el-button type="success" @click="submitForm('abc')" icon="el-icon-upload" style="margin-left: -25px;">登陆</el-button>
...
export default {
    data() {
            ...
            return {
                ...
                rules2: {
                    //分别为必填,不填的提示,
                    uname: [{ required: true, message: "登录ivanyb", trigger: "blur" }],
                    upwd: [{ required: true, message: "密码123", trigger: "blur" }]
                }
            };
        },
        methods: {
